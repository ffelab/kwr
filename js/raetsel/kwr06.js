const puzzleData = {
	...
	CLUES: {
		...
		SENKRECHT: {
			...
			2: { c: "Stachelt den Hasen zum Rennen an", l: "4", s: "IGEL" },
			3: { c: "Kurze Nummer \nkann auch mal verneinen", l: "2", s: "NO" },
			4: { c: "Kfz.-Kennzeichen Itzehoe", l: "2", s: "IZ" },
			5: {
			...
			10: {
				c: "Entscheidet über früher oder später",
				l: "5",
				s: "TEMPO",
			},
			11: {
