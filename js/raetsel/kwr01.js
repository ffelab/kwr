const puzzleData = {
	...
	CLUES: {
		WAAGERECHT: {
			...
			13: {
				c: "Digitaler Marktplatz \nfür gebastelten Kitsch",
				l: "4",
				s: "ETSY",
			},
			14: {
			...
			18: {
				c: "Gemeinschaftlicher Turnsport vielerorts",
				l: "3",
				s: "TSG",
			},
			19: {
				c: "Gewächses erdwärts orientierter",
				l: "4",
				s: "ROOT",
			},
			23: {
		...
		SENKRECHT: {
			...
			4: {
				c: "Zahl, die zählt in der Königsspielordnung",
				l: "3",
				s: "ELO",
			},
			5: {
